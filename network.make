...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/Debug/network
  TARGETDIR  = lib
  TARGET     = $(TARGETDIR)/libnetwork.a
  DEFINES   += 
  INCLUDES  += -Isrc -I.
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/Release/network
  TARGETDIR  = lib
  TARGET     = $(TARGETDIR)/libnetwork.a
  DEFINES   += -DNDEBUG
  INCLUDES  += -Isrc -I.
...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/network
  TARGETDIR  = lib
  TARGET     = $(TARGETDIR)/libnetwork.a
  DEFINES   += -DNDEBUG
  INCLUDES  += -Isrc -I.
...
$(OBJDIR)/Address.o: src/network/Address.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/BSDSocket.o: src/network/BSDSocket.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/DNSResolver.o: src/network/DNSResolver.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/Network.o: src/network/Network.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/Simulator.o: src/network/Simulator.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"

#ifndef GAME_CHANNEL_STRUCTURE_H
#define GAME_CHANNEL_STRUCTURE_H

#include "protocol/ReliableMessageChannel.h"
#include "core/Memory.h"
#include "GameMessages.h"

class GameChannelStructure : public protocol::ChannelStructure
{
    protocol::ReliableMessageChannelConfig m_config;

public:

    GameChannelStructure( GameMessageFactory & messageFactory )

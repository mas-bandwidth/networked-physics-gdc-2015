...
#ifndef PROTOCOL_BSD_SOCKETS_INTERFACE_H
#define PROTOCOL_BSD_SOCKETS_INTERFACE_H
...
namespace protocol
{
    ...
    struct BSDSocketsInterfaceConfig
    {
        BSDSocketsInterfaceConfig()
        {
            port = 10000;
    ...
    class BSDSocketsInterface : public NetworkInterface
    {
    public:
        ...
        BSDSocketsInterface( const BSDSocketsInterfaceConfig & config = BSDSocketsInterfaceConfig() )
            : m_config( config )
        {
...
//                cout << "sent ipv4 packet" << endl;
        ...
        const BSDSocketsInterfaceConfig m_config;

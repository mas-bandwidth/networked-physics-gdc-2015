...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/Debug/SoakProtocol
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/SoakProtocol
  DEFINES   += 
  INCLUDES  += -I../src -I..
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/Release/SoakProtocol
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/SoakProtocol
  DEFINES   += -DNDEBUG
  INCLUDES  += -I../src -I..
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/SoakProtocol
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/SoakProtocol
  DEFINES   += 
  INCLUDES  += -I../src -I..
...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/SoakProtocol
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/SoakProtocol
  DEFINES   += -DNDEBUG
  INCLUDES  += -I../src -I..
...
$(OBJDIR)/SoakProtocol.o: ../tests/SoakProtocol.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"

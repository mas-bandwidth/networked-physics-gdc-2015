...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/Debug/ProfileClientServer
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/ProfileClientServer
  DEFINES   += 
  INCLUDES  += -I../src -I..
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/Release/ProfileClientServer
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/ProfileClientServer
  DEFINES   += -DNDEBUG
  INCLUDES  += -I../src -I..
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/ProfileClientServer
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/ProfileClientServer
  DEFINES   += 
  INCLUDES  += -I../src -I..
...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/ProfileClientServer
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/ProfileClientServer
  DEFINES   += -DNDEBUG
  INCLUDES  += -I../src -I..
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking ProfileClientServer
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning ProfileClientServer
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/ProfileClientServer.o: ../tests/ProfileClientServer.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"

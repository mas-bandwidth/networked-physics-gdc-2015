...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/Debug/FontBuilder
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/FontBuilder
  DEFINES   += 
  INCLUDES  += -I../src -I..
  ...
  LIBS      += ../lib/libcore.a -lfreetype -ljansson
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/Release/FontBuilder
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/FontBuilder
  DEFINES   += -DNDEBUG
  INCLUDES  += -I../src -I..
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/FontBuilder
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/FontBuilder
  DEFINES   += 
  INCLUDES  += -I../src -I..
...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/FontBuilder
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/FontBuilder
  DEFINES   += -DNDEBUG
  INCLUDES  += -I../src -I..
...
$(OBJDIR)/FontBuilder.o: ../tools/FontBuilder/FontBuilder.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"

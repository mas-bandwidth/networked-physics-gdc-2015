...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/Debug/SoakClientServer
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/SoakClientServer
  DEFINES   += 
  INCLUDES  += -I../src -I..
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/Release/SoakClientServer
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/SoakClientServer
  DEFINES   += -DNDEBUG
  INCLUDES  += -I../src -I..
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/SoakClientServer
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/SoakClientServer
  DEFINES   += 
  INCLUDES  += -I../src -I..
...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/SoakClientServer
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/SoakClientServer
  DEFINES   += -DNDEBUG
  INCLUDES  += -I../src -I..
...
clean:
	@echo Cleaning SoakClientServer
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/SoakClientServer.o: ../tests/SoakClientServer.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"

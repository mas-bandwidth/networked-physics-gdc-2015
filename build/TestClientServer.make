...
ifeq ($(config),release_x64)
  RESCOMP = windres
  TARGETDIR = ../bin
  TARGET = $(TARGETDIR)/TestClientServer
  OBJDIR = obj/x64/Release/TestClientServer
  DEFINES += -DNDEBUG
...
ifeq ($(config),debug_x64)
  ...
  TARGETDIR = ../bin
  TARGET = $(TARGETDIR)/TestClientServer
  OBJDIR = obj/x64/Debug/TestClientServer
  DEFINES +=
  INCLUDES += -I../src -I../external -I../tools -I..
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
clean:
	@echo Cleaning TestClientServer
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/TestClientServer.o: ../tests/ClientServer/TestClientServer.cpp
	@echo $(notdir $<)

...
void test_bsd_sockets_interface_send_to_hostname()
{
    cout << "test_bsd_sockets_interface_send_to_hostname" << endl;

    BSDSocketsInterfaceConfig config;
    ...
    BSDSocketsInterface interface( config );
    ...
    for ( int i = 0; i < 20; ++i )
    {
        ...
        if ( interface.GetCounter( BSDSocketsInterface::PacketsSent ) == numPackets )
            break;
...
void test_bsd_sockets_interface_send_to_hostname_failure()
{
    cout << "test_bsd_sockets_interface_send_to_hostname_failure" << endl;
    ...
    for ( int i = 0; i < 20; ++i )
    {
        ...
        if ( interface.GetCounter( BSDSocketsInterface::PacketsDiscarded ) == numPackets )
            break;
...
void test_bsd_sockets_interface_send_and_receive_ipv4()
{
    cout << "test_bsd_sockets_interface_send_and_receive_ipv4" << endl;
...
void test_bsd_sockets_interface_send_and_receive_ipv6()
{
    cout << "test_bsd_sockets_interface_send_and_receive_ipv6" << endl;
...
int main()
{
    ...
    try
    {
        test_bsd_sockets_interface_send_to_hostname();
        test_bsd_sockets_interface_send_to_hostname_failure();
        test_bsd_sockets_interface_send_and_receive_ipv4();
        test_bsd_sockets_interface_send_and_receive_ipv6();
    }
